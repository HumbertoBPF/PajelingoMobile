...
public class ConjugationGameAnswer {
    ...
    public ConjugationGameAnswer(Long wordId, String tense, String conjugation1,
                                 String conjugation2, String conjugation3, String conjugation4,
                                 String conjugation5, String conjugation6) {
        this.wordId = wordId;
        this.tense = tense;
